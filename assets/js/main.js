(function ($) {
  ...
  */
  ...
  /*--------------------------------------------------------------
    Lang dropdown (sync with hidden selects)
  --------------------------------------------------------------*/
  ...
  function stickyHeaderTopBar() {
    var scroll = $(window).scrollTop();
    if (scroll >= 10) {
      $('.menu_top_bar').addClass('menu_top_bar_hidden');
    } else {
      $('.menu_top_bar').removeClass('menu_top_bar_hidden');
    }
  }
